...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center bg-slate-50 px-4 py-12 overflow-hidden selection:bg-blue-500 selection:text-white transition-colors duration-200">
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-md rounded-3xl border border-slate-200 bg-white/90 p-8 shadow-2xl backdrop-blur-xl transition-all duration-200"
      >
        {/* Brand Identity */}
        <div className="text-center">
          ...
          <h1 className="mt-4 text-2xl font-extrabold tracking-tight text-slate-900">SUSU9</h1>
        ...
        <div className="mt-8 flex justify-center">
          <Tabs
            ...
            className="w-full justify-center bg-slate-100 p-1 border border-slate-200/80"
          />
        </div>
            ...
            <Input
              ...
              rightIcon={
                <button
                  ...
                  className="focus:outline-none text-slate-400 hover:text-slate-900"
                >
        ...
        <div className="mt-8 border-t border-slate-200 pt-4 text-center text-[11px] text-slate-500">
