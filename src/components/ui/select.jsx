    ...
    <div className={cn("w-full space-y-1.5", wrapperClassName)}>
      ...
      <div className="relative flex items-center">
        <select
          id={selectId}
          className={cn(
            "flex h-10 w-full appearance-none rounded-xl border border-slate-200 bg-white px-3 py-2 pr-8 text-sm text-slate-900 shadow-xs transition-all duration-200 focus-visible:border-blue-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/20 disabled:cursor-not-allowed disabled:opacity-50",
